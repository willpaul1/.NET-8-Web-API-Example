...
namespace BaseLibrary.DTOs
{
    ...
    public class EventDto
    {
        ...
        public ICollection<LeadArtistsInfoDto> LeadArtitstsDto { get; set; } = new List<LeadArtistsInfoDto>();
        public ICollection<BackupArtistsInfoDto> BackupArtistsDto { get; set; } = new List<BackupArtistsInfoDto>();
